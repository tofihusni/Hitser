...
module.exports = [
  ...
  { title: 'La Bamba', artist: 'Ritchie Valens', year: 1958, es: true },
  ...
  { title: 'Un Beso y Una Flor', artist: 'Nino Bravo', year: 1972, es: true },
  ...
  { title: 'Devuélveme a mi chica', artist: 'Hombres G', year: 1985, es: true },
  { title: 'Livin\' on a Prayer', artist: 'Bon Jovi', year: 1986 },
  { title: 'Hijo de la Luna', artist: 'Mecano', year: 1986, es: true },
  ...
  { title: 'La Bamba', artist: 'Los Lobos', year: 1987, es: true },

  // ── Años 90 ──────────────────────────────────────────────
  { title: 'De Música Ligera', artist: 'Soda Stereo', year: 1990, es: true },
  ...
  { title: 'Macarena', artist: 'Los del Río', year: 1993, es: true },
  ...
  { title: 'Ciega, Sordomuda', artist: 'Shakira', year: 1998, es: true },
  ...
  { title: 'Como Camarón', artist: 'Estopa', year: 1999, es: true },

  // ── Años 2000 ────────────────────────────────────────────
  { title: 'Whenever, Wherever', artist: 'Shakira', year: 2001 },
  { title: 'A Dios le Pido', artist: 'Juanes', year: 2002, es: true },
  ...
  { title: 'Rosas', artist: 'La Oreja de Van Gogh', year: 2003, es: true },
  { title: 'Gasolina', artist: 'Daddy Yankee', year: 2004, es: true },
  { title: 'La Camisa Negra', artist: 'Juanes', year: 2005, es: true },
  ...
  { title: 'Bailando', artist: 'Enrique Iglesias', year: 2014, es: true },
  ...
  { title: 'Despacito', artist: 'Luis Fonsi ft. Daddy Yankee', year: 2017, es: true },
  { title: 'Shape of You', artist: 'Ed Sheeran', year: 2017 },
  { title: 'Mi Gente', artist: 'J Balvin & Willy William', year: 2017, es: true },
  { title: 'Felices los 4', artist: 'Maluma', year: 2017, es: true },
  { title: 'Havana', artist: 'Camila Cabello', year: 2017 },
  { title: 'New Rules', artist: 'Dua Lipa', year: 2017 },
  { title: 'Malamente', artist: 'Rosalía', year: 2018, es: true },
  { title: 'Bad Guy', artist: 'Billie Eilish', year: 2019 },
  { title: 'Callaíta', artist: 'Bad Bunny', year: 2019, es: true },
  ...
  { title: 'Tú Me Dejaste de Querer', artist: 'C. Tangana', year: 2020, es: true },
  { title: 'Drivers License', artist: 'Olivia Rodrigo', year: 2021 },
  { title: 'As It Was', artist: 'Harry Styles', year: 2022 },
  { title: 'Tití Me Preguntó', artist: 'Bad Bunny', year: 2022, es: true },
  { title: 'Despechá', artist: 'Rosalía', year: 2022, es: true },
  { title: 'Provenza', artist: 'Karol G', year: 2022, es: true },
  { title: 'Quédate', artist: 'Quevedo & Bizarrap', year: 2022, es: true },
  { title: 'Anti-Hero', artist: 'Taylor Swift', year: 2022 },
  { title: 'Flowers', artist: 'Miley Cyrus', year: 2023 },
  { title: 'Ella Baila Sola', artist: 'Eslabon Armado & Peso Pluma', year: 2023, es: true },
  { title: 'Shakira: Bzrp Music Sessions, Vol. 53', artist: 'Bizarrap & Shakira', year: 2023, es: true },
  ...
  { title: 'La Flaca', artist: 'Jarabe de Palo', year: 1996, es: true },
  ...
  { title: 'Sofía', artist: 'Álvaro Soler', year: 2016, es: true },
  { title: 'Súbeme la Radio', artist: 'Enrique Iglesias', year: 2017, es: true },
  { title: 'Échame la Culpa', artist: 'Luis Fonsi & Demi Lovato', year: 2017, es: true },
  { title: 'Con Calma', artist: 'Daddy Yankee ft. Snow', year: 2019, es: true },
  { title: 'Señorita', artist: 'Shawn Mendes & Camila Cabello', year: 2019 },
  { title: 'Con Altura', artist: 'Rosalía & J Balvin', year: 2019, es: true },
  ...
  { title: 'Pepas', artist: 'Farruko', year: 2021, es: true },
  { title: 'Todo de Ti', artist: 'Rauw Alejandro', year: 2021, es: true },
  { title: 'La Bachata', artist: 'Manuel Turizo', year: 2022, es: true },
  { title: 'TQG', artist: 'Karol G & Shakira', year: 2023, es: true },
  ...
  { title: 'Gata Only', artist: 'FloyyMenor & Cris MJ', year: 2024, es: true },
];
